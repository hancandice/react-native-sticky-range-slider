...
| `minRange`                | Minimum range between the low and high values.                                                                                                                                           | `number`                                              |                  _**0**_                   |
...
| `renderThumb`                | 	Function to render the thumb component.                                                                                                                                                    | `() => React.ReactNode`                                                   |                 _**Default Thumb**_                  |
